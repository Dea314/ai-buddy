...
export class MemoryManager {
  ...
  public async vectorSearch(recentChatHistory: string, buddyFileName: string) {
    ...
    const similarDocs = await vectorStore
      .similaritySearch(recentChatHistory, 3, { fileName: buddyFileName })
      .catch((err) => {
  ...
  public async writeToHistory(text: string, buddyKey: BuddyKey) {
